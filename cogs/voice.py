...
class voice(commands.Cog):
    ...
    async def help(self, ctx):
        ...
        embed.set_author(name="EG Scrims",url="https://discord.gg/saVwvwk", icon_url="https://cdn.discordapp.com/avatars/710857281637449760/a65cd3d2cbb746bac2365f7d786cc40c.png?size=1024")
        embed.add_field(name=f'**Commands**', value=f'**Lock your channel by using the following command:**\n\n`.voice lock`\n\n------------\n\n'
                        ...
                        f'**Give users permission to join by using the following command:**\n\n`.voice permit @person`\n\n**Example:** `.voice permit Mentux Lucifer#0001`\n\n------------\n\n'
                        f'**Claim ownership of channel once the owner has left:**\n\n`.voice claim`\n\n**Example:** `.voice claim`\n\n------------\n\n'
                        f'**Remove permission and the  userfrom your channel using the following command:**\n\n`.voice reject @person`\n\n**Example:** `.voice reject Mentux Lucifer#0001`\n\n', inline='false')
        embed.set_footer(text='Bot developed by Mentux Lucifer#0001')
    ...
    async def setlimit(self, ctx, num):
        conn = sqlite3.connect('voice.db')
        c = conn.cursor()
        if ctx.author.id == ctx.guild.owner.id or ctx.author.id == 700656817344086078:
